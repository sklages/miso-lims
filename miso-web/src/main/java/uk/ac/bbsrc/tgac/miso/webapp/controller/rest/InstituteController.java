...
public class InstituteController extends RestController {
  ...
  @ResponseBody
  public InstituteDto createInstitute(@RequestBody InstituteDto instituteDto, UriComponentsBuilder uriBuilder, HttpServletResponse response)
      throws IOException {
  ...
  public void deleteInstitute(@PathVariable(name = "id", required = true) long id, UriComponentsBuilder uriBuilder,
